...
const TenantSuperAdminController_1 = require("../controllers/superadmin/TenantSuperAdminController");
const userTasksByAdminControler_1 = require("../controllers/superadmin/userTasksByAdminControler");
 ...
 */
router.get("/listallusers", authMiddleware_1.protect, userTasksByAdminControler_1.getAllUsers);
/**
 * @swagger
 ...
 */
router.post("/create", TenantSuperAdminController_1.createSuperAdmin);
/**
 * @swagger
 ...
 */
router.post("/login", TenantSuperAdminController_1.superAdminLogin);
/**
 * @swagger
 ...
 *         description: SuperAdmin not found
 */
router.get("/:tenantId", TenantSuperAdminController_1.getSuperAdmin);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.post("/users", userTasksByAdminControler_1.addUser);
