 ...
 */
router.get("/d/:domainId", tenantController_1.getTenantByDomainId);
/**
 * @swagger
 * /api/tenants:
 *   post:
...
router.get("/", authMiddleware_1.protect, tenantController_1.listTenants);
/**
 * @swagger
 ...
 */
router.get("/:tenantId", tenantController_1.getTenantById);
router.put("/:tenantId", tenantController_1.updateTenant);
router.delete("/:tenantId", tenantController_1.deleteTenant);
/**
 * @swagger
 ...
 */
router.post("/:tenantId/api-keys", authMiddleware_1.protect, tenantController_1.issueApiKey);
/**
 * @swagger
 ...
 */
router.put("/:tenantId/api-keys/:keyHash/revoke", tenantController_1.revokeApiKey);
/**
 * @swagger
 ...
 */
router.put("/:tenantId/subscription", tenantController_1.updateSubscription);
/**
 * @swagger
 ...
 */
router.post("/verify-keys", authMiddleware_1.protect, tenantController_1.verifyApiKey);
