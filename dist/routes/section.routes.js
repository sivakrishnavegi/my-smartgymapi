 ...
 */
router.get("/", authMiddleware_1.protect, sectionController_1.getSections);
/**
 * @swagger
 * /api/sections/{id}:
 *   get:
 ...
 */
router.put("/:id", authMiddleware_1.protect, sectionController_1.updateSection);
/**
 * @swagger
 * /api/sections/{id}:
 *   delete:
 ...
 *                   example: "Server Error"
 */
router.get("/:sectionId/students", authMiddleware_1.protect, sectionController_1.getStudentsBySection);
/**
 * @swagger
 * /api/sections/{sectionId}/students:
 *   post:
 ...
 *         description: Internal server error
 */
router.post("/:sectionId/students", authMiddleware_1.protect, sectionController_1.addStudentToSection);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/:sectionId/students/:studentId", authMiddleware_1.protect, sectionController_1.getStudent);
